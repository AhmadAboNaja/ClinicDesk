            ...
            <div class="col-md-8">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-calendar-plus mr-1"></i> Appointment Details</h3>
                    </div>
                    <form method="POST" action="index.php?page=appointments&action=book">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="reason" name="reason" rows="3" required placeholder="Describe your reason for the appointment..."></textarea>
                            </div>
                        </div>
